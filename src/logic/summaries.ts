...
export function getEchoSummary(trip: TripDraft) {
  ...
  if (tags.includes('romantic') || tags.includes('relax')) return 'This feels more like a reset trip than a packed itinerary.';
  if (mustDoCount > 4) return 'You have a lot of highlights. Pick the top 3 first so this stays fun.';
