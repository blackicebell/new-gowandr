...
const styles = StyleSheet.create({
  ...
  tripRow: { flexDirection: 'row', alignItems: 'center', gap: 12, padding: 10, borderRadius: 22, backgroundColor: colors.paper, borderWidth: 1, borderColor: colors.line },
  tripRowActive: { borderColor: colors.teal, backgroundColor: colors.cloud },
  ...
  check: { color: colors.muted, fontWeight: '900', fontSize: 12 },
  checkActive: { color: colors.tealDark },
