...
const styles = StyleSheet.create({
  kicker: { color: colors.coral, fontWeight: '900', textTransform: 'uppercase', fontSize: 12, marginTop: 12 },
  title: { color: colors.charcoal, fontWeight: '900', fontSize: 34, lineHeight: 39, marginTop: 5 },
  ...
  scoreText: { color: colors.tealDark, fontWeight: '900' },
  winnerTitle: { color: colors.white, fontWeight: '900', fontSize: 32, padding: 20 },
  ...
  statLabel: { color: colors.coral, fontWeight: '900', fontSize: 10, textTransform: 'uppercase' },
  statValue: { color: colors.charcoal, fontWeight: '900', fontSize: 17, marginTop: 8 },
